  ...
  export default {
  	...
  	methods: {
  		...
  		deleteName(){
  			...
  			//使用$delete或Vue.delete
  			this.$delete(this.person, 'name');
  			Vue.delete(this.person, 'name');
  		}，
  		updateInfo(){
  			// 界面不会更新
  			//this.person.hobby[0] = '打电动';
  			// 界面更新
  			this.$set(this.person.hobby, 0, '爬山');
  			//splice也可以
  			this.person.hobby.splice(0, 1, '遛狗')
  		}
  	}
  }
  ```
...
<div style="border:1px solid black;width:380px;float:left;margin-right:20px;">
    ...
    <img src="https://v2.cn.vuejs.org/images/lifecycle.png" alt="lifecycle_2" style="zoom:50%;width:1200px" />
</div>
<div style="border:1px solid black;width:510px;height:980px;float:left">
    <strong>vue3.0的生命周期</strong>
    <img src="https://cn.vuejs.org/assets/lifecycle.16e4c08e.png" alt="lifecycle_2" style="zoom:50%;width:2500px" />
</div>
